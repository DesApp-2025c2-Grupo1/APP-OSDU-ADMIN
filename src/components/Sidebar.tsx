...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {/* Navigation */}
      <nav className="flex-1 w-full px-1 md:px-3 py-2 md:py-4 md:space-y-1 grid grid-cols-4 md:block items-center md:justify-start overflow-hidden md:overflow-visible">
        {!collapsed && (
