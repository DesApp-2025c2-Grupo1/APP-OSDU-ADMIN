...
interface ConfirmPlaceChangeDialogProps {
    open: boolean;
    providerName: string;
    agendaCount: number;
    onConfirm: () => void;
...
export function ConfirmPlaceChangeDialog({
    open,
    providerName,
    agendaCount,
    onConfirm,
            ...
            <div className="bg-white rounded-lg w-[90%] max-w-md p-6 shadow-lg">
                <div className="flex items-start gap-3 mb-4">
                    ...
                    <div>
                        <h2 className="text-lg font-semibold text-gray-800">
                            ¿Modificar lugares de atención?
                        </h2>
                        <p className="text-sm text-gray-600 mt-1">
                            Esta acción afectará las agendas existentes
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                    <p className="text-sm text-gray-700 mb-3">
                        ...
                        {agendaCount > 1 ? "s" : ""} asociada{agendaCount > 1 ? "s" : ""} a los lugares
                        de atención actuales.
                    </p>
                    <p className="text-sm text-gray-700">
                        Si modificas los lugares de atención, todas las agendas relacionadas se
                ...
                <div className="flex gap-3 justify-end">
                    ...
                    >
                        {isLoading ? "Guardando..." : "Sí, modificar"}
                    </button>
                </div>
            </div>
        </div>
